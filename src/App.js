...
{/* API Key- 064d435d4bfe489393f64c2d9ecc7be5*/}
    ...
    return (
      ...
      />
        ...
        <Routes>
          ...
          <Route exact path="/general" element={<News setProgress={this.setProgress}   key="general" pageSize={10} country='in' category='general'/>}></Route>
